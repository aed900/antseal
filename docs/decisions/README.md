...
| [D19](D19-advisory-lane.md) | Advisory lane — cargo-deny ONLY (`=0.19.8` CI pin); deny.toml advisories/bans/sources active, licenses stubbed → D6/Q29 (BlueOak-1.0.0 minicbor, GPL-3.0 self_encryption notes); per-PR `audit-deny` + weekly cron; every ignore carries justification + review date | RESOLVED (FROZEN) | 2026-07-27 |
