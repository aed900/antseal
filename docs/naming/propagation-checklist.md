...
| 6 | GitHub repo / org | `aed900/antseal` (relocated 2026-07-27 from `aed900/antseal` — see D2 amendment; user+org `antseal` free as of 2026-07-27) | **P** | Renameable-later (GitHub renames leave redirects); settle before the repo goes public (M4). |
