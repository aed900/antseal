...
- Repo hosting platform + CI provider (working assumption GitHub + Actions, needed for scheduled lanes in P13/P19); blocks P4, P8; pre-M0. — **[2026-07-27]** RESOLVED: GitHub + GitHub Actions, private repo aed900/antseal (docs/decisions/D2-hosting-ci.md; remote-CI verification status in docs/ci-verification.md). — **[2026-07-27 amendment]** relocated to **`aed900/antseal`** (project disassociated from the aed900 account; full commit-identity rewrite to aed900 pre-first-push; old repo deprecated, deletion is a aed900-account maintainer action).
