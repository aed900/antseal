...
- Notes: The address rule and cap are pinned against upstream source by S9 (`ant_protocol::MAX_CHUNK_SIZE = 4_194_304`, BLAKE3-256 per ant-protocol chunk.rs); F's M0 manifest golden vectors may use synthetic addresses until this lands.
