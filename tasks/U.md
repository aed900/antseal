...
- **[2026-08-02 lane m1-cli2 — NOT STARTED; ground survey recorded so the next lane does not re-derive it]** U37/U38/U11 consumed the lane's runway; `seal` is untouched and still returns the M1 not-implemented stub. What was verified about the ground, none of it built:
...
- **[2026-08-02 lane m1-cli2 — NOT STARTED; blockers cleared, shape fixed]** U37 removed the two things that made this task unbuildable, so what remains is construction rather than decision:
