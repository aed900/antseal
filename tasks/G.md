...
- Normalization crate + exact Unicode data version + multi-version retention architecture (the G1 decision itself; needs upstream verification of the crate's shipped Unicode version). Blocks G1 and all canonicalization downstream. M0.
